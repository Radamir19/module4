...
public class StudentController {
    ...
    public ResponseEntity<Page<StudentDto>> getAllStudents(@RequestParam(defaultValue = "0") @PositiveOrZero int page,
    ...
    public ResponseEntity<StudentDto> getStudent(@PathVariable("id") @Positive Long id) {
    ...
    public ResponseEntity<StudentDto> addToGroup(@PathVariable @Positive Long studentId, @PathVariable @Positive Long groupId) {
    ...
    public ResponseEntity<Void> removeFromGroup(@PathVariable("studentId") @Positive Long studentId, @PathVariable("groupId") @Positive Long groupId) {
    ...
    public ResponseEntity<Void> deleteStudent(@PathVariable("id") @Positive Long id) {
